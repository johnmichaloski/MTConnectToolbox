...
public:
	...
	bool selectTable(std::vector<std::vector<std::string> > & result , std::string schema, std::string table, std::vector<std::string> &fields, DataDictionary &typedata);
	bool selectTableWhere(std::vector<std::vector<std::string> > & result ,  std::string schema, std::string table,std::string where, std::vector<std::string> &fields, DataDictionary &typedata);
...
protected:
	...
	SQLRETURN GetResultset(std::vector<std::vector<std::string> > & colData);
