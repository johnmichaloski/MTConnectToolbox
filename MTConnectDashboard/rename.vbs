...
'path = Inputbox ("Path:", "Path", "C:\Users\michalos\Documents\GitHub\MTConnectToolbox\MTConnectDashboard")
oldStr = Inputbox ("OldString:", "String", "MtConnectDashboard")
newStr= Inputbox ("NewString:", "String", "MTConnectDashboard")
