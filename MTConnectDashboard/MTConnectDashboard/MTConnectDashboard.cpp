// MtConnectDashboard.cpp : main source file for MtConnectDashboard.exe
//
...
//		run nmake -f MtConnectDashboardps.mk in the project directory.
#include "initguid.h"
...
//	HRESULT hRes = ::CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	//	{
	//		_Module.UpdateRegistryFromResource(IDR_MtConnectDashboard, FALSE);
	...
	//	{
	//		_Module.UpdateRegistryFromResource(IDR_MtConnectDashboard, TRUE);
