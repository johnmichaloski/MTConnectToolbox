...
#define ITEM_FORMAT_ADDBOX			9
#define ITEM_FORMAT_MENU			10
...
#define ITEM_IMAGE_ADDBOX			10
#define ITEM_IMAGE_SUBBOX			11
#define ITEM_IMAGE_COPY			12
...
#define LCN_ENTERCOMBO				( LCN_FIRST - 8 )
