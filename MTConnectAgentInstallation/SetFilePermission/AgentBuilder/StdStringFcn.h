...
/**
	std::string path = "C:\\Program Files\\NIST\\proj\\MTConnect\\Nist\\AgentBuilderDevicesXML\\AgentBuilder\\Debug";
	std::string fullpath = RecursiveFileFind(path, "NIST-SimController.txt");
*/
#include <dirent.h>
