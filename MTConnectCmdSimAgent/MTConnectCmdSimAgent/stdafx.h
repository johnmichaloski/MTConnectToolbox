...
//#define TIME(X) {	NIST::Millitime mt;  mt._nTMsTimeStart= mt.GetMilliCount(); X; OutputDebugString(StdStringFormat("%s elapsed=%8d\n", #X, mt.GetMilliSpan(mt._nTMsTimeStart)).c_str()); }
#define TIME(X) X; 
