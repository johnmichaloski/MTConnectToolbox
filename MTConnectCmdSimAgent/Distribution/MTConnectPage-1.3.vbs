	...
	For Each item In nodes
     ...
     For Each sample In samples
        ...
        For Each child In sample.ChildNodes
            ...
            Else
            	If Not child.Attributes.getNamedItem("dMTConnectCmdSimItemId") Is Nothing Then
    			readings.Add child.Attributes.getNamedItem("dMTConnectCmdSimItemId").NodeValue, child.Text
		end if
            End If
     ...
     Set events = item.SelectNodes(".//Condition")
      For Each e In events
        ...
        For Each child In e.ChildNodes
            ...
            Else
             	If Not child.Attributes.getNamedItem("dMTConnectCmdSimItemId") Is Nothing Then
    			readings.Add child.Attributes.getNamedItem("dMTConnectCmdSimItemId").NodeValue,  child.nodeName & ":" & child.Text
		end if
            End If
        Next
      Next
...
'On Error Resume Next
table = ""
table = table & "<P> Current Readings " & CStr(j) & "<BR>"
