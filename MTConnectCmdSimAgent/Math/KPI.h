...
public:
	...
	double  AUPT; //Actual production time  nProductionTime; 
	double APT;
	double   ADET; //Actual unit delay time = nBlockedTime+ nStarvedTime; 
	double   PBZ; //Planned Busy time (BLZ);
	double BT; //=APT + ADET + ASUT; Busy time (BLZ)\n";
