...
void KPI::Init(Stats & stats1) 
{
	...
	this->nBlockedTime=stats1["blocked"];
	this->nStarvedTime=stats1["starved"];
	this->nDownTime=stats1["down"];
	this->nProductionTime=stats1["busy"];
	this->nOffTime=stats1["off"];
	this->nRepairTime=stats1["repair"];
	this->nIdleTime=stats1["idle"];
...
if(nTotalParts<=0)
	...
	POQ=0; // FIXME: workorder total parts - // Production order quantity
...
std::string KPI::EquationCSVString()
{
	...
	tmp+="Comprehensive Energy Consumption,	e, e = E/PQ\n";	// =（∑Mi*Ri + Q）/ PQ\n";	
