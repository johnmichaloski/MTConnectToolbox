...
/*                                                       */
/* Copyright (C) 2002 by FANUC LTD. All rights reserved. */
/*                                                       */
/*-------------------------------------------------------*/
using System;
...
//      ref short a, short b, ref short c, ref short d, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBDGN e );
    ...
    public static extern short cnc_rdunsolicmsg( short a, [Out,MarshalAs(UnmanagedType.LPStruct)] IDBUNSOLICMSG b );
...
/*-----*/
    ...
    public static extern short pmc_rdpmcrng( ushort FlibHndl,
        short a, short b, ushort c, ushort d, ushort e, [Out,MarshalAs(UnmanagedType.LPStruct)] IODBPMC f );

    /* write PMC data(area specified) */
    [DllImport("FWLIB32.dll", EntryPoint="pmc_wrpmcrng")]
    public static extern short pmc_wrpmcrng( ushort FlibHndl, ushort a, [In,MarshalAs(UnmanagedType.LPStruct)] IODBPMC b );
