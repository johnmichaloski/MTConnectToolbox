       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // CommandState
    //
    if (n.name () == "CommandState" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< CommandState_type > r (
        CommandState_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // CommandStatus
    //
    if (n.name () == "CommandStatus" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< CommandStatus_type > r (
        CommandStatus_traits::create (i, f, this));
    ...
    // JointStatuses
    //
    if (n.name () == "JointStatuses" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< JointStatuses_type > r (
        JointStatuses_traits::create (i, f, this));
    ...
    // Pose
    //
    if (n.name () == "Pose" && n.namespace_ ().empty ())
    {
    ...
    // GripperStatus
    //
    if (n.name () == "GripperStatus" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< GripperStatus_type > r (
        GripperStatus_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // GripperName
    //
    if (n.name () == "GripperName" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< GripperName_type > r (
        GripperName_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // JointStatus
    //
    if (n.name () == "JointStatus" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< JointStatus_type > r (
        JointStatus_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // Finger1Position
    //
    if (n.name () == "Finger1Position" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< Finger1Position_type > r (
        Finger1Position_traits::create (i, f, this));
    ...
    // Finger2Position
    //
    if (n.name () == "Finger2Position" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< Finger2Position_type > r (
        Finger2Position_traits::create (i, f, this));
    ...
    // Finger3Position
    //
    if (n.name () == "Finger3Position" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< Finger3Position_type > r (
        Finger3Position_traits::create (i, f, this));
            ...
            const ::xml_schema::properties& p)
{
      ...
      n.namespace_ () == "")
  {
    ::std::auto_ptr< ::CRCLStatusType > r (
      ::xsd::cxx::tree::traits< ::CRCLStatusType, char >::create (
        e, f, 0));
    return r;
  }
