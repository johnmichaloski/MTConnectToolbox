       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // InitCanon
    //
    if (n.name () == "InitCanon" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< InitCanon_type > r (
        InitCanon_traits::create (i, f, this));
    ...
    // MiddleCommand
    //
    if (n.name () == "MiddleCommand" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< MiddleCommand_type > r (
        MiddleCommand_traits::create (i, f, this));
    ...
    // EndCanon
    //
    if (n.name () == "EndCanon" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< EndCanon_type > r (
        EndCanon_traits::create (i, f, this));
             ...
             const ::xml_schema::properties& p)
{
      ...
      n.namespace_ () == "")
  {
    ::std::auto_ptr< ::CRCLProgramType > r (
      ::xsd::cxx::tree::traits< ::CRCLProgramType, char >::create (
        e, f, 0));
    return r;
  }
