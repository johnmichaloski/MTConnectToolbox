       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // ActuateJoint
    //
    if (n.name () == "ActuateJoint" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< ActuateJoint_type > r (
        ActuateJoint_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // JointDetails
    //
    if (n.name () == "JointDetails" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< JointDetails_type > r (
        JointDetails_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // ConfigureJointReport
    //
    if (n.name () == "ConfigureJointReport" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< ConfigureJointReport_type > r (
        ConfigureJointReport_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // AxisPoint
    //
    if (n.name () == "AxisPoint" && n.namespace_ ().empty ())
    {
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // Waypoint
    //
    if (n.name () == "Waypoint" && n.namespace_ ().empty ())
    {
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // EndPosition
    //
    if (n.name () == "EndPosition" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< EndPosition_type > r (
        EndPosition_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // TransSpeed
    //
    if (n.name () == "TransSpeed" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< TransSpeed_type > r (
        TransSpeed_traits::create (i, f, this));
    ...
    // RotSpeed
    //
    if (n.name () == "RotSpeed" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< RotSpeed_type > r (
        RotSpeed_traits::create (i, f, this));
    ...
    // TransAccel
    //
    if (n.name () == "TransAccel" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< TransAccel_type > r (
        TransAccel_traits::create (i, f, this));
    ...
    // RotAccel
    //
    if (n.name () == "RotAccel" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< RotAccel_type > r (
        RotAccel_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // Fraction
    //
    if (n.name () == "Fraction" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< Fraction_type > r (
        Fraction_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // ProgramText
    //
    if (n.name () == "ProgramText" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< ProgramText_type > r (
        ProgramText_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // ParameterSetting
    //
    if (n.name () == "ParameterSetting" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< ParameterSetting_type > r (
        ParameterSetting_traits::create (i, f, this));
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // StopCondition
    //
    if (n.name () == "StopCondition" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< StopCondition_type > r (
        StopCondition_traits::create (i, f, this));
