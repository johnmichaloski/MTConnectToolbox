...
REM C:\Users\michalos\Documents\bin\uncrustify-0.59-win32\uncrustify -c :\Users\michalos\Documents\bin\uncrustify-0.59-win32/rr.cfg --show-config > uncrustconfig.txt
REM pause
REM exit
