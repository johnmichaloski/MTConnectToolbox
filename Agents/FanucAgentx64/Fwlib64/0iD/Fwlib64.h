...
/* Path Table Oparation History */                                                                                                                          /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_num( unsigned short FlibHndl, long* hist_num );                                                                           /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_gb( unsigned short FlibHndl, long hist_idx, ODBPTHIS_GB *odbpthis_gb );                                                   /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_pt( unsigned short FlibHndl, long hist_idx, long path, ODBPTHIS_PT *odbpthis_pt );                                        /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_ax( unsigned short FlibHndl, long hist_idx, long path, long axis, ODBPTHIS_AX *odbpthis_ax );                             /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_sp( unsigned short FlibHndl, long hist_idx, long path, long spdl, ODBPTHIS_SP *odbpthis_sp );                             /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_aux( unsigned short FlibHndl, long hist_idx, long path, ODBPTHIS_AUX *odbpthis_aux );                                     /*E23582*/
FWLIBAPI short WINAPI cnc_rdpthis_log( unsigned short FlibHndl, long hist_idx, long type, long path, long idx, long* count, ODBPTHIS_LOG *odbpthis_log );   /*E23582*/
...
/* USB Memory          */
/*---------------------*/
/* get device infomation for USB Memory */
FWLIBAPI short WINAPI cnc_rdusbdevinfo(unsigned short FlibHndl, char *drive, ODBUSBSIZE *size);
/* get file list infomation of USB Memory */
FWLIBAPI short WINAPI cnc_rdusbfilelist(unsigned short FlibHndl, IDBUSBFILE *usb_file_in, ODBUSBINFO *usb_info_out, ODBUSBFILE *usb_file_out);
/* make folder in USB Memory */
FWLIBAPI short WINAPI cnc_usbmkdir(unsigned short FlibHndl, char *path);
/* delete folder in USB Memory */
FWLIBAPI short WINAPI cnc_usbrmdir(unsigned short FlibHndl, char *path);
/* delete file in USB Memory */
FWLIBAPI short WINAPI cnc_usbremove(unsigned short FlibHndl, char *path);
/* rename folder / file in USB Memory */
FWLIBAPI short WINAPI cnc_usbrename(unsigned short FlibHndl, char *path, char *fname);
/* check existence of file in USB Memory */
FWLIBAPI short WINAPI cnc_chkusbfile(unsigned short FlibHndl, char* path, char* exist);
/* search file/folder in USB Memory */
FWLIBAPI short WINAPI cnc_searchusbfile(unsigned short FlibHndl, IDBUSBSEARCH *usb_search_in, unsigned long *offset);
