...
'-------------------------------------
    ...
    Declare Function cnc_acts2 Lib "FWLIB32.DLL" _
        (ByVal FlibHndl As Integer, ByRef a As ODBACT2) As Short
...
'-----
    ...
    Declare Function pmc_rdpmcrng Lib "FWLIB32.DLL" _
        (ByVal FlibHndl As Integer, _
        ByVal a As Short, ByVal b As Short, ByVal c As Integer, ByVal d As Integer, ByVal e As Integer, ByRef f As IODBPMC) As Short

    ' write PMC data(area specified) 
    Declare Function pmc_wrpmcrng Lib "FWLIB32.DLL" _
        (ByVal FlibHndl As Integer, ByVal a As Integer, ByRef b As IODBPMC) As Short
