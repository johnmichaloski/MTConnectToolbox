...
public:
	...
	*/
	...
	std::string mPort;                                     //!< socket port of the ur robot controller status channel.
	...
	float mUrVersion;                                      //!< version of UR communication interface from ini
