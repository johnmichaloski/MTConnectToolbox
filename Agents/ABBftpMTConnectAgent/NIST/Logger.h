...
#define UNIQUE_ID(base) PP_CAT(base, __LINE__)

#define LOGONCE  static long UNIQUE_ID(nLog)=0; if( 0 == UNIQUE_ID(nLog)++) 
#define EXECONCE  static long UNIQUE_ID(nLog)=0; if( 0 == UNIQUE_ID(nLog)++) 
//#define LOGONCE  
