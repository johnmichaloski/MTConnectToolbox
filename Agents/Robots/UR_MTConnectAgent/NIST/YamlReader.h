...
* GLOBAL.section1.key) which is thanks to Al Chisolm of OPC Classic.
* The uppermost section (assumes no section has been declared) is called GLOBAL.
* Each section under the GLOBAL is GLOBAL.section1,
* GLOBAL.section2, etc. Embedded sections within a section are  OO concatenated
* (e.g., GLOBAL.section1.section11).
*/
struct YamlReader
{
    /**
    ...
    */
    ...
    /**
    * \brief Uses a full key path name (GLOBAL.section1.section2.keyname) to find
