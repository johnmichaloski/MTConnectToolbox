...
C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\UR_Agent\IncludeDirX32.txt

to point to the location of you UR_Agent (now in C:\Users\michalos\Documents\GitHub\UR_MTConnectAgen)
which contains:

-I"C:\Program Files\NIST\src\boost_1_54_0"
-I.
-I"C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\MTConnectAgent\agent"
-I"C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\MTConnectAgent\lib"
-I"C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\MTConnectAgent\win32\libxml2-2.7.7\include"
-I"C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\MTConnectAgent"
-I"C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\NIST"

3) IN the UR_Agent project setting for the linker, you will need to add the folders that point to your file location for:
a) C:\Users\michalos\Documents\GitHub\UR_MTConnectAgent\MTConnectAgent\win32\libxml2-2.7.7\lib
...
1) Create  install directory C:\Program Files\MTConnect\UR_Agent
...
4) Register Agent in Windows service as automatic with reference to UR_Agent BUT NOT STARTED
...
//		long ulFileSize = ftell(stream);
	...
	if (sec_sockfd_ < 0) {
		return _ur_adapter->ErrorMessage("ERROR opening socket sec_sockfd host %s\n", _host.c_str());
	}
