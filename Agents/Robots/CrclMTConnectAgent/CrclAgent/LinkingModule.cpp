...
#if 0
#define MTCLIBPATH(X)                                                         \
    "D:\\michalos\\My Work\\MTConnect\\CrclMTConnectAgent\\MTConnectAgent\\win32\\libxml2-2.7.7\\lib\\" ## X
#define BOOSTLIBPATH(X) \
    "D:\\Program Files\\NIST\\src\\boost_1_54_0\\stageX32\\lib\\" ## X
#define CODESYN(X) \
   "D:\\Program Files\\CodeSynthesis XSD 4.0\\lib\\vc-10.0\\"##X
#else
#define MTCLIBPATH(X)                                     \
    "C:\\Users\\michalos\\Documents\\GitHub\\Robots\\CrclMTConnectAgent\\MTConnectAgent\\win32\\libxml2-2.7.7\\lib\\" ## X
#define BOOSTLIBPATH(X) \
    "C:\\Program Files\\NIST\\src\\boost_1_54_0\\vc10\\stagex64\\lib\\"##X
#define CODESYN(X) \
   "C:\\Program Files (x86)\\CodeSynthesis XSD 4.0\\lib64\\vc-10.0\\"##X
#endif
...
#pragma comment(lib, CODESYN("xerces-c_3D"))
...
#pragma comment(lib, CODESYN("xerces-c_3"))
...
#pragma comment(lib, BOOSTLIBPATH("libboost_date_time-vc100-mt-sgd-1_54.lib"))
#pragma comment(lib, BOOSTLIBPATH("libboost_regex-vc100-mt-sgd-1_54.lib"))
#pragma comment(lib, BOOSTLIBPATH("libboost_chrono-vc100-mt-sgd-1_54.lib"))
#pragma comment(lib, CODESYN("xerces-c_3D"))
