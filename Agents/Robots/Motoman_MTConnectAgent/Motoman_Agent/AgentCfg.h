...
public:
    ...
    void        UpdateDevice (std::string cfgname, std::string ip = "",
                              std::string port = "");
    void        Run ( );
    void        SpawnProcess ( );
    ...
    LRESULT     WriteCfgFile (std::string cfgfile, std::string xmlfile,
                              std::string _destFolder);
    LRESULT     WriteAgentCfgFile (std::string cfgfile, std::string xmlfile,
                                   std::string _destFolder);
    ...
    std::vector<std::string> ips, ports, rates, debugs, devices, names,
                             alldevices;
